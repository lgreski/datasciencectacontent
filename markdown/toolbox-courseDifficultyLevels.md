...
<tr><td valign="top" halign="left">6. Reproducible Research</td><td valign="top" halign="left">I rate this course as slightly more challenging than <em>Getting and Cleaning Data</em> because students need to apply what they learned in <em>GCD</em> to a real world problem. Messy data and ambiguous documentation from our friends at the <a href="">National Oceanic and Atmospheric Administration</a> leave many decisions to be made by the student.
